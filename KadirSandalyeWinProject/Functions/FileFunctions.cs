...
namespace KadirSandalyeWinProject.Functions
{
    public static class FileFunctions
    {
        ...
        public static void FormSablonYukle(this string sablonAdi, XtraForm frm)
        {
            ...
            try
            {
                if (File.Exists(Application.StartupPath + $@"\Şablon Dosyaları\{ sablonAdi}
                _location.xml"))
                {
        ...
        public static void TabloDısariAktar(this GridView tablo, DosyaTuru dosyaTuru, string dosyaFormati, string exelSayfaAdi = null)
        {
